    ...
    switch( request.dao.getDBType()){
      ...
      case "postgres":
        ...
        request.dao.execute( "INSERT INTO eventLog( ID, event, description, eventDate ) VALUES
          ...
          ( '1', 'not a test insert', NULL, '2014-12-30 08:36:01' ),
          ( '20', 'not a test insert', NULL, '2014-12-30 08:38:45' ),
          ( '215', 'test insert', NULL, '2014-12-30 08:38:44' ),
          ( '219', 'test named params', 'This is a description from a named param', '2014-12-30 08:38:46' ),
          ( '220', 'test insert', NULL, '2014-12-30 08:38:46' ) returning ID;" );
        request.dao.execute( "DROP TABLE IF EXISTS pets;" );
        request.dao.execute( "CREATE TABLE pets (
          ID SERIAL NOT NULL,
          _id varchar( 45 ) NOT NULL,
          userID varchar( 255 ),
        ...
        request.dao.execute( "INSERT INTO pets( ID, _id, userID, firstName, lastName, createdDate, modifiedDate ) VALUES
          ( '93', '7d5a4d53-0a80-6eaf-db2acdaf5ed86568', '1', 'dog', '', CURRENT_TIMESTAMP,CURRENT_TIMESTAMP ),
          ( '94', 'fbf08c9d-e8de-01f7-7c89d8b41b258aac', '8', 'dog', 'frog', CURRENT_TIMESTAMP,CURRENT_TIMESTAMP ),
          ( '95', 'fc059ee0-96ce-a99b-7c0f26be24e3271a', '12', 'dog', 'mog', CURRENT_TIMESTAMP,CURRENT_TIMESTAMP ),
          ( '96', 'fc0601c7-9f0b-fae9-0eb0b9ad5ac0ea93', '15', 'corn', 'dag', CURRENT_TIMESTAMP,CURRENT_TIMESTAMP ),
          ( '97', 'fc070c5c-9943-6503-a10e73bd72ab1125', '18', 'chicken', 'cat', CURRENT_TIMESTAMP,CURRENT_TIMESTAMP ),
          ( '98', 'fc0f2f26-efb3-fd03-1fb7a5e794be17f2', '21', 'beef', 'rat', CURRENT_TIMESTAMP,CURRENT_TIMESTAMP ),
          ( '99', 'fc108acf-0c05-7303-62273152f581f444', '24', 'dog', '', CURRENT_TIMESTAMP,CURRENT_TIMESTAMP );" );
        request.dao.execute( "DROP TABLE IF EXISTS users;" );
        request.dao.execute( "CREATE TABLE users (
          ID SERIAL NOT NULL,
          ...
          status int,
          created_timestamp timestamp NOT NULL DEFAULT NULL,
          modified_timestamp timestamp NOT NULL DEFAULT NULL,
          _id varchar( 200 ),
          email varchar( 255 ),
          PRIMARY KEY( ID )
        );" );
